...
namespace
{
    const char* const WINDOW_TITLE = "Justin Starr CS-360 Module 6 Milestone - Lighting Complex Objects"; // Macro for window title
...
void URender()
{
    ...
    // 1. Scales the object
    glm::mat4 scale = glm::scale(glm::vec3(12.0f, 8.0f, 1.0f));
