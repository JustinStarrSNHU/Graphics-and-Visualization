...
namespace
{
    const char* const WINDOW_TITLE = "Justin Starr CS-360 Module 2 Assignment"; // Macro for window title
 ...
 */
bool UInitialize(int, char* [], GLFWwindow** window); // initializes the program
void UResizeWindow(GLFWwindow* window, int width, int height); // sets the window size
...
// Vertex Shader Program Source Code. Source code for the vertex shader is stored in a const C string
...
// Fragment Shader Program Source Code. Source code for the fragment shader is stored in a const C string
...
void UCreateMesh(GLMesh& mesh)
{
    ...
    GLfloat verts[] =
    {
        ...
        // index 1
        -0.5f, 0.0f, 0.0f,      // middle-third of screen
        0.0f, 1.0f, 0.0f, 1.0f, // green

        // index 2
        -1.0f, 0.0f, 0.0f,      // middle-left of screen
        0.0f, 0.0f, 1.0f, 1.0f, // blue

        // index 3
        0.0f, -1.0f, 0.0f,       // bottom-middle of screen
        0.0f, 1.0f, 0.0f, 1.0f,  // green

        // index 4
        0.0f, 0.0f, 0.0f,       //  middle of screen
        1.0f, 0.0f, 0.0f, 1.0f  //  red
    };
    ...
    GLushort indices[] = { 0, 1, 2, 3, 1, 4 }; // Using index 1 twice because two triangles share the same indicie
...
bool UCreateShaderProgram(const char* vtxShaderSource, const char* fragShaderSource, GLuint& programId)
{
    ...
    // if the shader compile has an error, the error is displayed to the user.
    if (!success)
    {
    ...
    glAttachShader(programId, vertexShaderId); // attaches the vertex shader
    glAttachShader(programId, fragmentShaderId); // attaches the fragment shader
...
// de-allocates resource once it's outlived its purpose
void UDestroyShaderProgram(GLuint programId)
{
